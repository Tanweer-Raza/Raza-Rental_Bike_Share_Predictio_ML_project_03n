...
from bike_rental.constant import *
...
from bike_rental.util.util import read_yaml_file
...
class Configuration:
    def __init__(self,
        ...
        try:
            ...
            self.training_pipeline_config = self.get_training_pipeline_config() #artifact dir path
